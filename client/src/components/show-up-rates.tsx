...
export function ShowUpRatesComponent({ showUpRates }: ShowUpRatesProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Tasas de Asistencia</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-neutral-700">Primer Descubrimiento</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-neutral-700">Segundo Descubrimiento</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-neutral-700">Tercer Descubrimiento</span>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-neutral-700">Primer Cierre</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-neutral-700">Segundo Cierre</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-neutral-700">Tercer Cierre</span>
